                ...
                <form method="POST" action="{{ route('pagos.store') }}">
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        ...
                        <div>
                            ...
                            <select name="cliente_id" class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500" required>
                        ...
                        <div>
                            ...
                            <select name="membresia_id" class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="metodo_pago" class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500" required>
